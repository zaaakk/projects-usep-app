...
from usep_app.models import Collection, Inscription2, Publication, Publications
...
class CollectionTest( TestCase ):
  ...
  def test_get_solr_data(self):
    ...
    self.assertEqual( [ u'id', u'status' ], list_element_keys )
  ...
  def test_enhance_solr_data(self):
    ...
    self.assertEqual( [u'id', u'image_url', u'status', u'url'], list_element_keys )
...
class PublicationTest( TestCase ):
  ...
  def test_buildInscriptionList(self):
    ...
    self.assertEqual( sorted(pub.inscription_entries[0].keys()), [u'id', u'status'] )
...
class PublicationsTest( TestCase ):
  ...
  def test_buildPubLists_live_data(self):
    ...
    # print u'pubs.monographs_dict...'; pprint.pprint( pubs.monographs_dict )
    # print u'pubs.monographs...'; pprint.pprint( pubs.monographs )
    self.assertEqual( len(pubs.master_pub_dict.keys()), 177 )
